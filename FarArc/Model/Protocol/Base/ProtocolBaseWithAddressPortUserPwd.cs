...
namespace FarArc.Model.Protocol.Base
{
    public abstract class ProtocolBaseWithAddressPortUserPwd : ProtocolBaseWithAddressPort
    {
        ...
        public const string MACRO_USERNAME = "%FARARC_USERNAME%";
        private string _userName = "";
        [OtherName(Name = "FARARC_USERNAME")]
        ...
        public const string MACRO_PASSWORD = "%FARARC_PASSWORD%";
        private string _password = "";
        [OtherName(Name = "FARARC_PASSWORD")]
        ...
        public const string MACRO_PRIVATE_KEY_PATH = "%FARARC_PRIVATE_KEY_PATH%";
        private string _privateKey = "";
        [OtherName(Name = "FARARC_PRIVATE_KEY_PATH")]
