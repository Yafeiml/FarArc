...
namespace FarArc.Utils.Security
{
    /// <summary>
    ...
    {
        private const string FormatName = "fararcsec";
        ...
        private static readonly byte[] DerivationSalt = SHA256.HashData(
            Encoding.UTF8.GetBytes("FarArc.PortableStringCipher.HKDF-SHA256/v1"));
        private static readonly byte[] DerivationInfo =
            Encoding.UTF8.GetBytes("FarArc.PortableStringCipher.AES-256-GCM/v1");
