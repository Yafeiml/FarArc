...
namespace FarArc.Utils.WindowsSdk.PasswordVaultManager
{
    internal class PasswordVaultManagerFileSystem : IPasswordManager
    {
        ...
        //private static readonly string LocalFolder = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.UserProfile), ".FarArc");
