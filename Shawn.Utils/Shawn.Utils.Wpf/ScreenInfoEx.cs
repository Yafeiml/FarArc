...
*/
    ...
    public class ScreenInfoEx
    {
        ...
        {
            var k = new ScreenInfoEx(GetPrimaryScreen()).ScaleFactor;
        ...
        public static double GetGlobalScaleFactor()
        {
            ...
            var mainRealScaleFactor = 100.0 * primaryScreen.Bounds.Width / SystemParameters.PrimaryScreenWidth;
            var dmMain = new DEVMODE { dmSize = (short)Marshal.SizeOf(typeof(DEVMODE)) };
            EnumDisplaySettings(primaryScreen.DeviceName, ENUM_CURRENT_SETTINGS, ref dmMain);
            var mainLogicScaleFactor = 100.0 * dmMain.dmPelsWidth / primaryScreen.Bounds.Width;
        ...
        public static uint GetPrimaryScreenScaleFactor()
        {
            ...
            try
            {
                ...
                sf = (uint)(100 * GetPrimaryScreen().Bounds.Width / SystemParameters.PrimaryScreenWidth);
            }
            catch (Exception)
            {
                sf = 100;
